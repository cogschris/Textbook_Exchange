  ...
  <div class="row mb-3">
    <div id="form-error" class="col-sm-9 ml-sm-auto font-italic text-danger">
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="title-id" name="book_title" placeholder="Foundations of Accounting">
				</div>
			</div>
			<!-- .form-group -->
			...
			<?php
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="class-id" name="class_code" placeholder="401">
					</div>
				</div>
        ...
        <div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="price-id" name="price" placeholder="50.25">
					</div>
				</div>

        <div class="form-group row">
					<label for="pic-id" class="col-sm-3 col-form-label text-sm-right">Picture (2MB maximum): <span class="text-danger">*</span></label>
					<div class="col-sm-9">
...
<p>Please log in to view this area!</p>
            <?php
                ...
                || document.querySelector('#pic-id').value.trim().length == 0) {
